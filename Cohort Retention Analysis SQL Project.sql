...
(
			SELECT [InvoiceNo]
			 ...
			 --- UPDATE [PORTFOLIO].[dbo].['Online Retail$'] SET [CustomerID] = 0 WHERE [CustomerID] IS NULL
			 WHERE CustomerID != 0
)
...
---we now have 397667 clean data
-- and also 5215 duplicate records
select *
